...
import eu.vendeli.ktnip.collectors.*
...
class ActivityProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val activitiesFile = FileSpec.builder(DEFAULT_CODEGEN_PACKAGE, "ActivitiesData").apply {
            addSuppressions()
            addOptIn()
        ...
        val loaderFile = FileSpec.builder(DEFAULT_CODEGEN_PACKAGE, "KtGramCtxLoader").apply {
            addSuppressions()
            addOptIn()
