...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.sendPaidMediaSc(starCount: Int, media: List<InputPaidMedia>) = sendPaidMedia(starCount, media)
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.refundStarPaymentSc(telegramPaymentChargeId: String, userId: Long) =
