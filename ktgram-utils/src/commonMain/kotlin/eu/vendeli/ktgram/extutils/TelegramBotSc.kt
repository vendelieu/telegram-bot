...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.forwardMessagesSc(fromChatId: Identifier, messageIds: List<Long>) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.setMyCommandsSc(
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.audioSc(file: ImplicitFile) = audio(file)
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.getBusinessConnectionSc(businessConnectionId: String) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.copyMessagesSc(fromChatId: Identifier, messageIds: List<Long>) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.forwardMessageSc(fromChatId: Identifier, messageId: Long) = forwardMessage(fromChatId, messageId)

@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.contactSc(firstName: String, phoneNumber: String) = contact(firstName, phoneNumber)

@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.deleteMyCommandsSc(languageCode: String? = null, scope: BotCommandScope? = null) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.createForumTopicSc(
    name: String,
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.answerCallbackQuerySc(callbackQueryId: String) = answerCallbackQuery(callbackQueryId)
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.chatActionSc(action: ChatAction, messageThreadId: Int? = null) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.editMessageMediaSc(messageId: Long, inputMedia: InputMedia) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.editMessageLiveLocationSc(messageId: Long, latitude: Float, longitude: Float) =
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.setGameScoreSc(userId: Long, messageId: Long, score: Long) =
