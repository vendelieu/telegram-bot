...
import eu.vendeli.tgbot.api.business.DeleteBusinessMessagesAction
import eu.vendeli.tgbot.api.business.GetBusinessAccountGiftsAction
import eu.vendeli.tgbot.api.business.GetBusinessAccountStarBalanceAction
import eu.vendeli.tgbot.api.business.ReadBusinessMessageAction
import eu.vendeli.tgbot.api.business.RemoveBusinessAccountProfilePhotoAction
import eu.vendeli.tgbot.api.business.SetBusinessAccountBioAction
import eu.vendeli.tgbot.api.business.SetBusinessAccountGiftSettingsAction
import eu.vendeli.tgbot.api.business.SetBusinessAccountNameAction
import eu.vendeli.tgbot.api.business.SetBusinessAccountProfilePhotoAction
import eu.vendeli.tgbot.api.business.SetBusinessAccountUsernameAction
import eu.vendeli.tgbot.api.business.TransferBusinessAccountStarsAction
...
import eu.vendeli.tgbot.api.gift.ConvertGiftToStarsAction
import eu.vendeli.tgbot.api.gift.GiftPremiumSubscriptionAction
import eu.vendeli.tgbot.api.gift.TransferGiftAction
import eu.vendeli.tgbot.api.gift.UpgradeGiftAction
...
import eu.vendeli.tgbot.api.story.DeleteStoryAction
import eu.vendeli.tgbot.api.story.EditStoryAction
import eu.vendeli.tgbot.api.story.PostStoryAction
...
public inline fun TelegramBot.getBusinessAccountGifts(businessConnectionId: String): GetBusinessAccountGiftsAction = eu.vendeli.tgbot.api.business.getBusinessAccountGifts(businessConnectionId)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.setBusinessAccountUsername(businessConnectionId: String, username: String? = null): SetBusinessAccountUsernameAction = eu.vendeli.tgbot.api.business.setBusinessAccountUsername(businessConnectionId, username)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.deleteBusinessMessages(businessConnectionId: String, messageIds: List<Long>): DeleteBusinessMessagesAction = eu.vendeli.tgbot.api.business.deleteBusinessMessages(businessConnectionId, messageIds)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.removeBusinessAccountProfilePhoto(businessConnectionId: String, isPublic: Boolean? = null): RemoveBusinessAccountProfilePhotoAction = eu.vendeli.tgbot.api.business.removeBusinessAccountProfilePhoto(businessConnectionId, isPublic)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.setBusinessAccountProfilePhoto(
  businessConnectionId: String,
  photo: InputProfilePhoto,
  isPublic: Boolean? = null,
): SetBusinessAccountProfilePhotoAction = eu.vendeli.tgbot.api.business.setBusinessAccountProfilePhoto(businessConnectionId, photo, isPublic)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.setBusinessAccountGiftSettings(
  businessConnectionId: String,
  showGiftButton: Boolean,
  acceptedGiftTypes: AcceptedGiftTypes,
): SetBusinessAccountGiftSettingsAction = eu.vendeli.tgbot.api.business.setBusinessAccountGiftSettings(businessConnectionId, showGiftButton, acceptedGiftTypes)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.setBusinessAccountBio(businessConnectionId: String, bio: String? = null): SetBusinessAccountBioAction = eu.vendeli.tgbot.api.business.setBusinessAccountBio(businessConnectionId, bio)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.setBusinessAccountName(
  businessConnectionId: String,
  firstName: String,
  lastName: String? = null,
): SetBusinessAccountNameAction = eu.vendeli.tgbot.api.business.setBusinessAccountName(businessConnectionId, firstName, lastName)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.transferBusinessAccountStars(businessConnectionId: String, starCount: Int): TransferBusinessAccountStarsAction = eu.vendeli.tgbot.api.business.transferBusinessAccountStars(businessConnectionId, starCount)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.readBusinessMessage(businessConnectionId: String, messageId: Long): ReadBusinessMessageAction = eu.vendeli.tgbot.api.business.readBusinessMessage(businessConnectionId, messageId)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.getBusinessAccountStarBalance(businessConnectionId: String): GetBusinessAccountStarBalanceAction = eu.vendeli.tgbot.api.business.getBusinessAccountStarBalance(businessConnectionId)
...
@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.editStory(
  businessConnectionId: String,
  storyId: String,
  content: InputStoryContent,
): EditStoryAction = eu.vendeli.tgbot.api.story.editStory(businessConnectionId, storyId, content)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.deleteStory(businessConnectionId: String, storyId: String): DeleteStoryAction = eu.vendeli.tgbot.api.story.deleteStory(businessConnectionId, storyId)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.postStory(
  businessConnectionId: String,
  content: InputStoryContent,
  activePeriod: Duration,
): PostStoryAction = eu.vendeli.tgbot.api.story.postStory(businessConnectionId, content, activePeriod)
...
@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.transferGift(
  businessConnectionId: String,
  ownedGiftId: String,
  newOwnerChatId: Long,
  starCount: Int? = null,
): TransferGiftAction = eu.vendeli.tgbot.api.gift.transferGift(businessConnectionId, ownedGiftId, newOwnerChatId, starCount)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.upgradeGift(
  businessConnectionId: String,
  ownedGiftId: String,
  keepOriginalDetails: Boolean? = null,
  starCount: Int? = null,
): UpgradeGiftAction = eu.vendeli.tgbot.api.gift.upgradeGift(businessConnectionId, ownedGiftId, keepOriginalDetails, starCount)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.convertGiftToStars(businessConnectionId: String, ownedGiftId: String): ConvertGiftToStarsAction = eu.vendeli.tgbot.api.gift.convertGiftToStars(businessConnectionId, ownedGiftId)

@Suppress("NOTHING_TO_INLINE")
public inline fun TelegramBot.giftPremiumSubscription(
  userId: Long,
  monthCount: Int,
  starCount: Int,
  textParseMode: ParseMode? = null,
  noinline text: (() -> String)? = null,
): GiftPremiumSubscriptionAction = eu.vendeli.tgbot.api.gift.giftPremiumSubscription(userId, monthCount, starCount, textParseMode, text)
