...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.refundStarPaymentSc(telegramPaymentChargeId: String, userId: Long) = refundStarPayment(telegramPaymentChargeId,  userId)
@Suppress("NOTHING_TO_INLINE")
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.getStarTransactionsSc(offset: Int? = null, limit: Int? = null) = getStarTransactions(offset,  limit)
@Suppress("NOTHING_TO_INLINE")
...
@Suppress("NOTHING_TO_INLINE")
inline fun TelegramBot.setCustomEmojiStickerSetThumbnailSc(name: String, customEmojiId: String? = null) = setCustomEmojiStickerSetThumbnail(name,  customEmojiId)
@Suppress("NOTHING_TO_INLINE")
