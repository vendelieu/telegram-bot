...
* Added `catchExceptions` to turn off catching exceptions to `caughtExceptions`, and `throwExOnActionsFailure` to throw
  exceptions on api request sending failures.
