...
[![Supported version](https://img.shields.io/badge/Bot%20Api-7.2-blue?logo=telegram)](https://core.telegram.org/bots/api#march-31-2024)\
...
dependencies {
    // ...
    implementation("eu.vendeli:telegram-bot:5.2.0")
    ksp("eu.vendeli:ksp:5.2.0")
}
```
