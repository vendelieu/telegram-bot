...
sealed class Transition {
     ...
     */
    data class JumpTo(val step: KClass<out WizardStep>) : Transition()
...
class WizardContext(
     ...
     */
    suspend fun getState(step: KClass<out WizardStep>): Any? {
        return getStateManagerForStep(step)?.get(step, userReference)
    }
    ...
    private companion object {
        ...
        fun String.extractWizardId(): Int? = WIZARD_REGEX.find(this)?.groupValues?.get(1)?.toInt()
    }
}
