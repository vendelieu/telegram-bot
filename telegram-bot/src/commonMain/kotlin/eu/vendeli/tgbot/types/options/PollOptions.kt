...
data class PollOptions(
    ...
    var allowsRevoting: Boolean? = null,
    var shuffleOptions: Boolean? = null,
    var allowAddingOptions: Boolean? = null,
    var hideResultsUntilCloses: Boolean? = null,
    var correctOptionIds: List<Int>? = null,
