 ...
 */
public fun FunctionalHandlingDsl.onEditedBusinessMessage(
    block: suspend ActivityCtx<EditedBusinessMessageUpdate>.() -> Unit,
) {
 ...
 */
public fun FunctionalHandlingDsl.onDeletedBusinessMessages(
    block: suspend ActivityCtx<DeletedBusinessMessagesUpdate>.() -> Unit,
) {
 ...
 */
public fun FunctionalHandlingDsl.onMessageReactionCount(
    block: suspend ActivityCtx<MessageReactionCountUpdate>.() -> Unit,
) {
